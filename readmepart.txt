...
Create a new file in the components folder named
WidgetWrapper.jsx which is just like FlexBetween
but for the Widgets in the home page section

Create another file in the same folder named
UserImage.jsx top show the user profile image in
the homepage.

Create a new file in the widgets folder 
named UserWidget.jsx 
